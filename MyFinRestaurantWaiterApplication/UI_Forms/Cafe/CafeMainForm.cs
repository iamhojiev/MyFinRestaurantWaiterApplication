...
{
    public partial class CafeMainForm : Form
    {
        ...
        private UC_PageCasheCafe PageCashe;
        private User myUser;
        ...
        {
            if (PageCashe == null) PageCashe = new UC_PageCasheCafe();
            //else PageCashe.ShiftMaxenation();
            SetUserControl(PageCashe);
        }
